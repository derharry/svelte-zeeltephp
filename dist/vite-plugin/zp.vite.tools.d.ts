...
export function exec_task(title: any, name: any, todo: any, src: any, dst: any, filter: any, verbose?: boolean): boolean;
/**
 * copy a folder
 * @param {string} src
 * @param {string} dest
 ...
 */
export function copyRecursiveSync(src: string, dest: string, filter?: callback_function): void;
